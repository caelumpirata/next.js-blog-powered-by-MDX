          ...
          {isToggled && (
            ...
            <div className="absolute z-50 bottom-0 left-0 right-0 top-12 px-16 dark:bg-black bg-white border-t border-gray-200 dark:border-gray-800">
              ...
              <div className="absolute bottom-8">
                <ul className="flex">
                  <li className="-ml-3">
                    <Link onClick={resetOverflow} className="inline-block px-3 text-gray-500 text-xs tracking-wider uppercase sm:text-sm" href="https://twitter.com/caelumpirata" target="_blank" rel="noreferrer noopener">
                      <svg
                        stroke="currentColor"
                        fill="none"
                        strokeWidth="2"
