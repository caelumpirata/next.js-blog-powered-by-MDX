...
const Footer = () => {
  return (
    <footer className="mt-16 sm:mt-24 border">
      <div className="mx-auto max-w-2xl px-4 md:px-0 ">
        <div className="flex items-end justify-between py-8 border-t border-gray-300 dark:border-gray-700 sm:py-16">
          ...
          <ul className="flex">
            ...
            {/* <li className="-ml-3">
              <Link className="inline-block px-3 text-gray-500 text-xs tracking-wider uppercase sm:text-sm" href="https://twitter.com/jakewies" target="_blank" rel="noreferrer noopener">
              </Link>
            </li>
            <li>
              <Link className="inline-block px-3 text-gray-500 text-xs tracking-wider uppercase sm:text-sm" href="https://www.youtube.com/@caelumpirata" target="_blank" rel="noreferrer noopener">
            ...
            <li><a className="inline-block px-3 text-gray-500 text-xs tracking-wider uppercase sm:text-sm" href="https://github.com/caelumpirata" target="_blank" rel="noreferrer noopener"><svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="text-xl" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg></a></li>
